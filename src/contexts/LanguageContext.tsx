...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'dash.decide.title':    'Help me decide',
    'dash.decide.sub':      'Stuck on stuff? AI tells you keep, donate, or toss.',
    'dash.rooms':           'rooms',
    ...
    // Decision Coach (KonMari)
    'decide.title':            'Decide',
    'decide.heading':          "Stuck on stuff? Let's decide together.",
    'decide.subheading':       'Snap a photo of items you can\'t make a call on. AI gives you a clear next step for each one.',
    'decide.upload.title':     'Tap to capture or upload',
    'decide.upload.sub':       'One item or a small pile — both work',
    'decide.retake':           'Retake',
    'decide.intent.label':     'What are we looking at?',
    'decide.intent.single':    'Just one item',
    'decide.intent.single.sub':'Single tricky thing',
    'decide.intent.pile':      'A small pile',
    'decide.intent.pile.sub':  'Up to 8 items',
    'decide.analyze.btn':      'Get my recommendations',
    'decide.analyzing':        'Reading the items...',
    'decide.philosophy':       'KonMari-inspired: does it spark joy or serve a clear purpose?',
    'decide.action.keep':      'Keep',
    'decide.action.donate':    'Donate',
    'decide.action.sell':      'Sell',
    'decide.action.recycle':   'Recycle',
    'decide.action.toss':      'Toss',
    'decide.accept':           'Yes, do this',
    'decide.override':         'Different action',
    'decide.skip':             'Skip',
    'decide.cancel':           'Never mind',
    'decide.choose.action':    'Pick what you\'ll actually do',
  ...
  zh: {
    ...
    'dash.decide.title':    '帮我做决定',
    'dash.decide.sub':      '不知道留还是扔？AI 告诉你怎么处理。',
    'dash.rooms':           '个房间',
    ...
    // Decision Coach (KonMari)
    'decide.title':            '帮我决定',
    'decide.heading':          '纠结要不要扔？我们一起决定。',
    'decide.subheading':       '拍下你拿不定主意的东西，AI 会给每件物品一个明确的建议。',
    'decide.upload.title':     '点击拍照或上传',
    'decide.upload.sub':       '一件物品或一小堆都可以',
    'decide.retake':           '重拍',
    'decide.intent.label':     '我们看的是什么？',
    'decide.intent.single':    '只有一件',
    'decide.intent.single.sub':'单个棘手的物品',
    'decide.intent.pile':      '一小堆',
    'decide.intent.pile.sub':  '最多 8 件',
    'decide.analyze.btn':      '获取建议',
    'decide.analyzing':        '正在识别物品...',
    'decide.philosophy':       '近藤麻理惠式提问：它让你心动，或者还有清晰的用途吗？',
    'decide.action.keep':      '留下',
    'decide.action.donate':    '捐赠',
    'decide.action.sell':      '出售',
    'decide.action.recycle':   '回收',
    'decide.action.toss':      '丢弃',
    'decide.accept':           '好的，照做',
    'decide.override':         '换个做法',
    'decide.skip':             '跳过',
    'decide.cancel':           '取消',
    'decide.choose.action':    '选择你实际会做的',
